...
export default function SupervisorCreateLoanPage() {
    ...
    <div className="w-full min-h-screen bg-slate-100 pb-24">
      <header className="bg-slate-900 text-white shadow-md sticky top-0 z-50">
        <div className="max-w-md mx-auto px-4 py-3 flex items-center justify-between">
          <Link href="/supervisor/loans" className="text-xs text-slate-300 hover:text-white font-bold flex items-center gap-1">
            ‹ กลับ
          </Link>
      ...
      <main className="max-w-md mx-auto px-4 mt-4 space-y-4">
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm space-y-2 text-xs">
          <h3 className="font-bold text-slate-800 border-b pb-2">👤 ข้อมูลผู้ยื่นเรื่อง (Supervisor)</h3>
          <div className="flex justify-between text-slate-600">
            <span>ชื่อ-นามสกุล:</span>
            <span className="font-bold text-slate-900">{profile?.name || "ผู้ควบคุมงาน KMS"}</span>
          </div>
          <div className="flex justify-between text-slate-600">
          ...
          <div className="flex justify-between text-slate-600">
            ...
            <span className="font-bold text-amber-600">{profile?.branch || "ยังไม่ระบุหน่วยงาน"}</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm space-y-3.5 text-xs">
            ...
            <div className="p-3 bg-amber-50/80 rounded-2xl border border-amber-200 text-[11px] text-amber-950 space-y-1">
              <div className="flex justify-between items-center font-bold text-amber-900 border-b border-amber-200/60 pb-1">
              ...
              <div className="flex justify-between items-center font-bold text-emerald-700 text-xs pt-1 border-t border-amber-200/60">
              ...
              <input
                ...
                className={`w-full px-3 py-2.5 bg-slate-50 border rounded-xl font-mono text-sm outline-none transition ${
                  isOverLimit
                    ...
                    : "border-slate-200 text-slate-900 focus:bg-white focus:ring-2 focus:ring-amber-500"
                }`}
              />
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 focus:bg-white focus:ring-2 focus:ring-amber-500 outline-none resize-none"
              />
            </div>
          ...
          <div className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm space-y-3 text-xs">
            ...
            <p className="text-slate-500 text-[11px] leading-relaxed">
              ผู้ยื่นเรื่องต้องกดปุ่มอ่านหนังสือสัญญาฉบับเต็มและเลื่อนอ่านลงไปให้สุดเพื่อกดยินยอม
            </p>

            <button
              type="button"
              onClick={openContractModal}
              className="w-full py-2.5 bg-slate-100 hover:bg-amber-50 border border-slate-300 hover:border-amber-300 text-slate-800 font-bold rounded-xl transition flex items-center justify-center gap-2 cursor-pointer"
            >
              <span>📑</span>
            ...
            >
              <input
                ...
                className="mt-0.5 rounded text-amber-600 focus:ring-amber-500 w-4 h-4 shrink-0 pointer-events-none cursor-pointer"
              />
          ...
          <button
            ...
            className="w-full py-3.5 bg-amber-600 hover:bg-amber-700 text-white font-bold text-sm rounded-2xl shadow-lg shadow-amber-500/20 transition disabled:opacity-50 cursor-pointer"
          >
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-5 space-y-4 border border-slate-100 my-auto flex flex-col max-h-[85vh]">
            ...
            <div className="flex justify-between items-center border-b pb-3 shrink-0">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-xs font-bold text-slate-900">หนังสือสัญญากู้ยืมเงิน</h3>
              </div>
              <button
                type="button"
            ...
            >
              <div className="text-center space-y-1 pb-2 border-b">
                ...
                <p className="text-[10px] text-slate-500">
                  หนังสือสัญญากู้ยืมเงิน และหนังสือยินยอมให้หักเงินค่าจ้าง
                </p>
              </div>
            ...
            {!hasScrolledToBottom && (
              <p className="text-[10px] text-amber-600 font-bold text-center animate-pulse shrink-0">
