...
export default function SupervisorAttendanceHistoryPage() {
      ...
      <header className="bg-slate-900 text-white shadow-md sticky top-0 z-50">
        <div className="max-w-md mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <Link href="/supervisor/attendance" className="text-slate-300 hover:text-white text-xs font-bold px-2 py-1 bg-slate-800 rounded-lg">
              ⬅️ ย้อนกลับ
            </Link>
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                ...
                <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-200 space-y-1.5">
                  <div>
                    ...
                    <span className="font-bold text-amber-600 text-sm">{item.checkOut || "-"}</span>
                  ...
                  {item.imagesOut && item.imagesOut.length > 0 ? (
                    <button
                      ...
                      className="w-full py-1.5 bg-amber-600 hover:bg-amber-700 text-white text-[10px] font-bold rounded-lg transition shadow-sm cursor-pointer flex items-center justify-center gap-1"
                    >
