...
export default function SupervisorCreateReportPage() {
  ...
  // ดึงพิกัด GPS และโปรไฟล์ Supervisor
  useEffect(() => {
    fetchUserProfile();
    ...
    <div className="w-full min-h-screen bg-slate-100 pb-24">
      ...
      <header className="bg-slate-900 text-white shadow-md sticky top-0 z-50">
        <div className="max-w-md mx-auto px-4 py-3 flex items-center justify-between">
          <Link href="/supervisor/reports" className="text-xs text-slate-300 hover:text-white font-bold flex items-center gap-1">
            ‹ กลับ
          </Link>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-4 border border-slate-200 space-y-2">
            ...
            <select
              ...
              className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-900 focus:bg-white focus:ring-2 focus:ring-amber-500 outline-none cursor-pointer"
            >
          ...
          <div className="bg-white rounded-2xl shadow-sm p-4 border border-slate-200 space-y-3">
            ...
            <label className="flex flex-col items-center justify-center w-full h-28 border-2 border-dashed border-amber-300 hover:border-amber-500 rounded-2xl bg-amber-50/50 cursor-pointer transition">
              <span className="text-2xl mb-1">📷</span>
              <span className="text-xs font-bold text-amber-700">กดเพื่อถ่ายรูป / เลือกรูปภาพ</span>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-4 border border-slate-200 space-y-2.5">
            ...
            <div className="flex flex-wrap gap-1.5">
              <button
                ...
                className="px-2.5 py-1.5 bg-slate-100 hover:bg-amber-100 hover:text-amber-800 text-slate-700 text-[11px] font-medium rounded-xl border border-slate-200 transition text-left cursor-pointer"
              >
              ...
              <button
                type="button"
                onClick={() => applyQuickText("ผู้ควบคุมงาน เข้าตรวจการปฏิบัติงาน เหตุการณ์ปกติ")}
                className="px-2.5 py-1.5 bg-slate-100 hover:bg-amber-100 hover:text-amber-800 text-slate-700 text-[11px] font-medium rounded-xl border border-slate-200 transition text-left cursor-pointer"
              >
          ...
          <div className="bg-white rounded-2xl shadow-sm p-4 border border-slate-200 space-y-2">
            ...
            <textarea
              ...
              className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-900 focus:bg-white focus:ring-2 focus:ring-amber-500 outline-none resize-none"
            />
          </div>
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fadeIn">
          <div className="bg-white rounded-3xl p-6 max-w-xs w-full text-center space-y-4 shadow-2xl border border-slate-100">
            ...
            <button
              ...
              className="w-full py-3 bg-amber-600 hover:bg-amber-700 text-white font-bold text-xs rounded-2xl shadow-md shadow-amber-500/20 transition cursor-pointer"
            >
              ตกลง
            </button>
          </div>
